...
public class Floating {
    ...
    public Floating(final Registers register, final Memory memory, final String[] instruction) throws Exception {
        R = register;
        mem = memory;
    ...
    public void FADD() throws Exception {
        ...
        if (I.equals("0")) {
            ...
            final String value = String
                    .valueOf(Float.parseFloat(R.getFR(intFR)) + Float.parseFloat(mem.getMemValue(address))); 
            R.setFR(intFR, value);
            ...
            final String value = String.valueOf(
                    Float.parseFloat(R.getFR(intFR)) + Float.parseFloat(mem.getMemValue(mem.getMemValue(address)))); 
            R.setFR(intFR, value);
            System.out.println("result is: " + value);
            System.out.println("register data: " + R.getFR(intFR));
        }
        ...
        final int j = Integer.parseInt(address);
        ...
        int count = 0;
        /*
         * while (j1 > 0) { j1 = j1 / 10; count = count + 1;
         * 
         * } if (count < 5) { int count1 = 5 - count; while (count1 != 0) { q = 0 + q;
         * count1--; } }
         */
        ...
        s = op + String.valueOf(Integer.toBinaryString(Integer.parseInt(FR)))
                + String.valueOf(Integer.toBinaryString(Integer.parseInt(IX))) + I + q;
        ...
        cs.simulator.simulator.log
                .setText(cs.simulator.simulator.log.getText() + "Register value(R" + intFR + ")" + ":"); // Log is used
                                                                                                         // to display
                                                                                                         // the
                                                                                                         // description
                                                                                                         // of what is
    ...
    public void FSUB() throws Exception {
        ...
        if (I == "0") {
            final String value = String
                    .valueOf(Float.parseFloat(R.getFR(intFR)) - Float.parseFloat(mem.getMemValue(address))); // value =
                                                                                                             // c(FR) +
                                                                                                             // c(EA)
            R.setFR(intFR, value);
            System.out.println("result is: " + value);
            ...
            final String value = String.valueOf(
                    Float.parseFloat(R.getFR(intFR)) - Float.parseFloat(mem.getMemValue(mem.getMemValue(address)))); // value
                                                                                                                     // =
                                                                                                                     // c(FR)
                                                                                                                     // +
                                                                                                                     // c(EA)
    ...
    public void VADD() throws Exception {
        System.out.println("PC value before execution:" + R.getPC());
        final String address_V1 = address;
        final String address_V2 = String.valueOf(Integer.parseInt(address) + 1);
        final int int_addressV1 = Integer.parseInt(address_V1);
        final int int_addressV2 = Integer.parseInt(address_V2);
        for (int i = 0; i < (int) (Float.parseFloat(R.getFR(intFR))); i++) {
            R.setMAR((int_addressV1 + i) + "");
            R.setMBR(mem.getMemValue(R.getMAR()));

            // address1
            final String address1 = String.valueOf(i + Integer.parseInt(mem.getMemValue(address_V1)));
            System.out.println("address 1 should be 50 or 51: " + address1);

            // vector1 value
            final int v1 = Integer.parseInt(mem.getMemValue(address1));
            ...
            // address2
            final String address2 = String.valueOf(i + Integer.parseInt(mem.getMemValue(address_V2)));
            System.out.println("address 2 should be 52 or 53: " + address2);

            // vector2 value
            final int v2 = Integer.parseInt(mem.getMemValue(address2));
            ...
            final int MAX_VALUE = (int) (Math.pow(2, 6));
            final int MIN_VALUE = -(int) (Math.pow(2, 6));
    ...
    public void CNVRT() throws Exception {
        ...
        System.out.println("PC value before execution:" + R.getPC());
        R.setGPR(intFR, "0");
        final int F = Integer.parseInt(R.getGPR(intFR));
        R.setMAR(address);
        R.setMBR(mem.getMemValue(R.getMAR()));

        if (F == 0) {
            final String converted_number = String.format("%.4f", Float.parseFloat(R.getMBR()));
        ...
        cs.simulator.simulator.log.setText(cs.simulator.simulator.log.getText() + "Register value(R3):"); // Log is used
                                                                                                          // to display
                                                                                                          // the
                                                                                                          // description
                                                                                                          // of what is
    ...
    public void LDFR() throws Exception {
        ...
        s = op + String.valueOf(Integer.toBinaryString(Integer.parseInt(FR)))
                + String.valueOf(Integer.toBinaryString(Integer.parseInt(IX))) + I
                + String.valueOf(Integer.parseInt(q));
    ...
    public void STFR() throws Exception {
        ...
        /*
         * while (j1 > 0) { j1 = j1 / 10; count = count + 1; } if (count < 5 && j<63) {
         * int count1 = 5 - count; // System.out.println(count); while (count1 != 0) { q
         * = 0 + q; count1--; // System.out.println("hi"); } }
         */
        ...
        s = op + String.valueOf(Integer.toBinaryString(Integer.parseInt(FR)))
                + String.valueOf(Integer.toBinaryString(Integer.parseInt(IX))) + I + String.valueOf(q);
